"""Legacy implementation retained only for backward compatibility.

Do not use this module for the revised ETMNet evaluation protocol. The public
default is ``metrics.measurement_metrics``.
"""
